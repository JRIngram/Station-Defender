...
public class RapidFireWeapon extends Weapon {
	...
	/*String name, double speed, double damage, double rateOfFire, double health, double range, double chanceToHit, int x, int y, int width, int height,
    double buildTime, int cost, int costToUpgrade*/
	public RapidFireWeapon(int x, int y, int width, int height,
            double buildTime, int cost, int costToUpgrade){
