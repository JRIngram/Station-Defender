...
/**
 * PostLevelScreen is a class that shows at the end of each level
 *
 * @author Mohammed Foysal
 */
public class PostLevelScreen implements Screen{
     ...
     */
    public PostLevelScreen(boolean continueBool) {
